...
import 'package:ticket_box/src/utils/formatter.dart';
                ...
                children: [
                          ...
                          child: FloatingSearchBar(
                            ...
                            builder: (context, transition) {
                              return Material(
                                ...
                                child: Container(
                                  child: Obx(() {
                                    final listSearchEvent = controller.listSearchEvents;
                  ...
                  Container(
                    ...
                    child: Obx(() {
                      ...
                      final images = controller.listEvents.map((element) => element.imageUrl!).toList();
                      if (images.isEmpty)
                        return Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    width: 100,
                                                    height: 35,
                                                    child: Text(ticket.eventName.toString(),
                                        ...
                                        Column(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              width: 295,
                                              child: ListTile(
                                                title: Text(Formatter.shorten(event.eventName),),
                                                subtitle: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    Text('Địa chỉ: ' + event.location.toString()),
                                                    Container(
                                                      ...
                                                      child: Text(
                                                        "Thời gian: " + Formatter.date(event.timeOccur),
